...
max_items          = 19200;  (* number of items                             *)
max_trans          = 19200;  (* number of transitions                       *)
max_redns          =  2400;   (* number of reductions                        *)

max_rule_len       =   128;  (* maximum length of rules                     *)
max_set_items      =   192;  (* maximum number of items in an item set      *)
